<!-- Header Include -->
<?php
$pageTitle = "Privacy Policy | Techmefi";
$pageDescription = "";
...
<section class="privacy-terms">
    <div class="container">
        <h2 class="inner-heading">Privacy Policy</h2>
        <div class="content">
            <h2 class="sub-heading">Information We Collect</h2>
            ...
            <h2 class="sub-heading">Log Data</h2>
            ...
            <h2 class="sub-heading">Legitimate Reasons for Processing Your Personal Information</h2>
            ...
            <h2 class="sub-heading">Collection and Use of Information</h2>
            ...
            <h2 class="sub-heading">Security of Your Personal Information</h2>
            ...
            <h2 class="sub-heading">How Long We Keep Your Personal Information</h2>
            ...
            <h2 class="sub-heading">Children’s Privacy</h2>
            ...
            <h2 class="sub-heading">Disclosure of Personal Information to Third Parties</h2>
            ...
            <h2 class="sub-heading">International Transfers of Personal Information</h2>
            ...
            <h2 class="sub-heading">Your Rights and Controlling Your Personal Information</h2>
            ...
            <h2 class="sub-heading">Use of Cookies</h2>
            ...
            <h2 class="sub-heading">Limits of Our Policy</h2>
            <p>Our website may link to external sites that are not operated by us. Please be aware that we have no control over the content and policies of those sites, and cannot accept responsibility or liability for their respective privacy practices.</p>

            <h2 class="sub-heading">Changes to This Policy</h2>
